...
a reason we're hardcoding in a fake salt here. For actual authentication, 
we'll want to generate a salt and hash the password with passlib and bcrypt.
!!!!
"""
...
class UsersRepository(BaseRepository):
    ...
    async def get_user_by_user_name(self, *, username: str) -> UserInDB:
