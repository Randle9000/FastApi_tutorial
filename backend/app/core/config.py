...
JWT_ALGORITHM = config(
    "JWT_ALGORITHM", cast=str, default="HS256"
)  # algorithm to encode tokens
JWT_AUDIENCE = config(
    "JWT_AUDIENCE", cast=str, default="phresh:auth"
)  # TODO what exactly is it?
JWT_TOKEN_PREFIX = config(
    "JWT_TOKEN_PREFIX", cast=str, default="Bearer"
)  # TODO what exactly is it?
